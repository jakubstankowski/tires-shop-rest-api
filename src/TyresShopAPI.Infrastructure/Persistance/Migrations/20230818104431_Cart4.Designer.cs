...
namespace TyresShopAPI.Infrastructure.Migrations
{
    ...
    [Migration("20230818104431_Cart4")]
    partial class Cart4
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TyresShopAPI.Domain.Entities.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TyresShopAPI.Domain.Entities.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TyresShopAPI.Domain.Entities.CartItem", b =>
                {
                    b.HasOne("TyresShopAPI.Domain.Entities.Cart", "Cart")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("TyresShopAPI.Domain.Entities.Customers.Customer", b =>
                {
                    b.HasOne("TyresShopAPI.Domain.Entities.Customers.Address", "Address")
                        .WithOne("Customer")
                        .HasForeignKey("TyresShopAPI.Domain.Entities.Customers.Customer", "AddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

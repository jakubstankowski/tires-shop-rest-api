        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TyreType = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderTyre", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderTyre_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderTyre_Tyres_TyreId",
                        column: x => x.TyreId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderTyre_OrderId",
                table: "OrderTyre",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderTyre_TyreId",
                table: "OrderTyre",
                column: "TyreId");
